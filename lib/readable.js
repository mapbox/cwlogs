 ...
 * @param {string} [options.logStreamNames] - Optional list of log stream names
 ...
 * @param {number} [options.end=now] - read log events until the provided time (in ms since since Jan 01 1970)
...
function readable(options) {
  ...
  if (options.logStreamNames && !Array.isArray(options.logStreamNames)) return invalid();
